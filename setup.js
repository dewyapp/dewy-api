                            ...
                            'if (meta.id.substring(0, 6) == "site::" && doc.enabled == "1" && ("details" in doc) && !("error" in doc.audited)) {',
                                ...
                                'for (project in doc.details.projects) {',
                                    'for (module in doc.details.projects[project].modules) {',
                                        ...
                                        '}',
                                        'var update = false;',
                                        'if (doc.attributeDetails.modulesWithUpdates.indexOf(module) != -1) {',
                                            'update = true; ',
                                        '}',
                                        'var securityUpdate = false;',
                                        'if (doc.attributeDetails.modulesWithSecurityUpdates.indexOf(module) != -1) {',
                                            'securityUpdate = true; ',
                                        '}',
                                    ...
                                    'if (project != "") {',
                                        'for (module in doc.details.projects[project].modules) {',
                                            ...
                                            'if (doc.attributeDetails.modulesWithSecurityUpdates.indexOf(module) != -1) {',
                                                'moduleUpdateLevel = 2; ',
                                            '}',
                                            'else if (doc.attributeDetails.modulesWithUpdates.indexOf(module) != -1) {',
                                                'moduleUpdateLevel = 1; ',
                                            '}',
                                            'emit([project, core, moduleUpdateLevel], {sid: doc.sid, module: module});',
                                        '}',
                                    '}',
                                '}',
                            '}',
