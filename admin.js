        ...
        if (error) {
            ...
            for (domainIndex in domains) {
                ...
                for (siteIndex in domain.sites) {
                    ...
                    var core = '7.' + Math.floor(Math.random()*52);
                    ...
                    var emailDomainChoices = ['geemail.com', 'eyecloud.com', 'lukewarmmail.com'];
                    ...
                    for (var i=0; i<numberOfUsers; i++) {
                        ...
                        var emailDomainIndex = Math.floor(Math.random()*emailDomainChoices.length);
                        var createdOffset = Math.floor(Math.random()*timeAgoAdded);
                        users[userChoices[userIndex]] = { 
                            mail: userChoices[userIndex] + '@' + emailDomainChoices[emailDomainIndex],
                            created: Math.floor(Date.now() / 1000) - createdOffset,
                            last_access: Math.floor(Date.now() / 1000) - Math.floor(Math.random()*createdOffset),
                            status: 1,
                            roles: roles
                        };
                        var notBlocked = Math.floor(Math.random()*30);
                        if (!notBlocked) {
                            users[userChoices[userIndex]].status = 0;
                        }
                        var signedOn = Math.floor(Math.random()*20);
                        if (!signedOn) {
